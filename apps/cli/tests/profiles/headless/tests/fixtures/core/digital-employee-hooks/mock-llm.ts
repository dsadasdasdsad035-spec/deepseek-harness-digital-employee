...
class DigitalEmployeeHookMockAdapter extends LlmAdapter {
  ...
  async * stream(): AsyncIterable<StreamChunk> {
    ...
    if (this.rounds === 1) {
      ...
      yield { type: 'tool-call-delta', index: 0, id: ToolCallId('call-hook-echo'), name: 'hook__echo', argumentsDelta: '{"input":"assembled-round-trip"}' }
      yield { type: 'block-end', index: 0, block: { type: 'tool-call', id: ToolCallId('call-hook-echo'), name: 'hook__echo', arguments: '{"input":"assembled-round-trip"}' } }
