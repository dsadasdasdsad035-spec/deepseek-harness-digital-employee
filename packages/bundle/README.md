...
| [`digital-employee-suite/`](digital-employee-suite/README.md) | Optional Web extension for digital employee operations and Template configuration | mounts digital employee rows |
