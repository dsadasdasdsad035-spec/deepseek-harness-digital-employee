...
import { WorkflowMarketService } from "./service.js";
export { mountEmployeeWorkflows } from "./bridge.js";
...
let WorkflowMarketGateway = (() => {
    let _classSuper = TypertRemoteService;
    let _instanceExtraInitializers = [];
    let _list_decorators;
    let _install_decorators;
    let _uninstall_decorators;
    return class WorkflowMarketGateway extends _classSuper {
        static {
        ...
        async installedPackages() {
            ...
            for (const entry of inventory.value.entries) {
                try {
                    ...
                    this.service.setDiagnostic(entry.packageId, error instanceof Error ? error.message : 'workflow package validation failed');
                }
            }
            return installed;
        }
