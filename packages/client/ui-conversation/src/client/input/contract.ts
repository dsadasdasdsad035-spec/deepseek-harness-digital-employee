...
export interface Occurrence {
  ...
  /** Routing references claim submission and are omitted from model-visible content. */
  readonly submission?: ReferenceInsert['submission']
...
export type InputEffect =
  ...
  | {
    readonly type: 'route-submit'
    readonly attempt: SubmitAttempt
    readonly route: Pick<Occurrence, 'source' | 'ref'>
