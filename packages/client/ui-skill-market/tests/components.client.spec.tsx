...
function setup(options: SetupOptions = {}) {
  ...
  const props: SkillMarketSectionProps = {
    ...
    workflowController: { store: { '~stub': true } } as never,
    subagentController: { store: { '~stub': true } } as never,
    hooks: {
      snapshot: store.store,
      toolSnapshot: toolStore.store,
      mcpSnapshot: mcpStore.store,
      workflowSnapshot: mcpStore.store,
      subagentSnapshot: mcpStore.store,
    ...
    useWorkflowSnapshot: bindSnapshotSelector(mcpStore.store),
    useSubagentSnapshot: bindSnapshotSelector(mcpStore.store),
