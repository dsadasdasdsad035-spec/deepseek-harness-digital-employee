...
export interface ILayout {
  ...
  closeDetails(): void
  /** Show the shell application workspace instead of the conversation. */
  openApplication(): void
  /** Return from the shell application workspace to the conversation. */
...
export class LayoutController implements ILayout {
  ...
  /** Show the shell application workspace instead of the conversation. */
  openApplication(): void {
    this.#require().openApplication()
  }

  /** Return from the shell application workspace to the conversation. */
  closeApplication(): void {
    this.#require().closeApplication()
  }
