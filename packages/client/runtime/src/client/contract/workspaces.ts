...
/** Blank-session reuse policy for a Workspace connection. */
export interface WorkspaceConnectOptions {
  /** False forces a distinct ordinary blank Session for an isolated draft. */
  readonly reuseBlank?: boolean
}
...
export interface IWorkspaces {
   ...
   * @param options - whether an existing blank Session may be reused.
