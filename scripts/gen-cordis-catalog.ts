...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  agents: 'core.md',
  digitalEmployeeAgent: 'core.md',
  digitalEmployeeManagement: 'core.md',
  digitalEmployees: 'core.md',
  companies: 'core.md',
  companyManagement: 'core.md',
  companyGroupChat: 'core.md',
  apiProxy: 'typert.md',
  ...
  mcpMarket: 'tools.md',
  hookMarket: 'tools.md',
  workflowMarket: 'tools.md',
  subagentMarket: 'tools.md',
  lsp: 'lsp.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DigitalEmployeeInstanceId: '../user/guide/digital-employees.md',
  CompanyId: '../user/guide/digital-employees.md',
  DepartmentId: '../user/guide/digital-employees.md',
  CompanyProvider: '../user/guide/digital-employees.md',
  CompanyRecord: '../user/guide/digital-employees.md',
  EmployeeBinding: '../user/guide/digital-employees.md',
  CreateCompanyRequest: '../user/guide/digital-employees.md',
  UpdateCompanyRequest: '../user/guide/digital-employees.md',
  AddDepartmentRequest: '../user/guide/digital-employees.md',
  RenameDepartmentRequest: '../user/guide/digital-employees.md',
  ReorderDepartmentsRequest: '../user/guide/digital-employees.md',
  DeleteDepartmentRequest: '../user/guide/digital-employees.md',
  AssignEmployeeRequest: '../user/guide/digital-employees.md',
  UnassignEmployeeRequest: '../user/guide/digital-employees.md',
  CompanyPromoImageRef: '../user/guide/digital-employees.md',
  CompanyPromoImageValue: '../user/guide/digital-employees.md',
  SetCompanyPromoImageRequest: '../user/guide/digital-employees.md',
  CompanyIdRequest: '../user/guide/digital-employees.md',
  CompanyFloor: '../user/guide/digital-employees.md',
  CompanyCandidateEmployee: '../user/guide/digital-employees.md',
  CompanyGroupView: '../user/guide/digital-employees.md',
  CompanyWorldStateView: '../user/guide/digital-employees.md',
  CompanyCarState: '../user/guide/digital-employees.md',
  CompanyEmployeePosition: '../user/guide/digital-employees.md',
  ReportCompanyWorldStateRequest: '../user/guide/digital-employees.md',
  EmployeePresenceView: '../user/guide/digital-employees.md',
  EmployeeVisitEntry: '../user/guide/digital-employees.md',
  ReportEmployeeVisitRequest: '../user/guide/digital-employees.md',
  EmployeePresenceRequest: '../user/guide/digital-employees.md',
  CompanyGroupMember: '../user/guide/digital-employees.md',
  CompanyGroupMessage: '../user/guide/digital-employees.md',
  DigitalEmployeeLifecycleState: '../user/guide/digital-employees.md',
  DigitalEmployeeTemplateId: '../user/guide/digital-employees.md',
  ...
  SubagentResult: 'subagent.md',
  SubagentStartRequest: 'subagent.md',
  SkillSelection: 'skills.md',
...
const DIGITAL_EMPLOYEE_TYPE_EXEMPTIONS = Object.fromEntries([
  'AppendDigitalEmployeeAuditRequest',
  'ApplyDigitalEmployeeUpgradeRequest',
  'CreateDigitalEmployeePreviewTaskRequest',
  'CreateDigitalEmployeeRequest',
  'CreateDigitalEmployeeTemplateDraftRequest',
  'CreateDigitalEmployeeTaskRequest',
  'DelegateToDigitalEmployeeExpertRequest',
  ...
  'DigitalEmployeeExpertDelegation',
  ...
  'DigitalEmployeeTemplateReferenceValidator',
  ...
  'ResolvedDigitalEmployeeExpert',
  'ResolveDigitalEmployeeExpertRequest',
  'DisposeDigitalEmployeeTemplatePreviewRequest',
  'UpdateDigitalEmployeeTemplateDraftRequest',
].map(type => [type, 'digital employee product types are owned by the digital-employee package READMEs'] as const))

/** Project types deliberately documented outside the subsystems catalog. */
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...DIGITAL_EMPLOYEE_TYPE_EXEMPTIONS,
  z: 'schemastery schema constructor is owned by vendor/schemastery (vendored upstream)',
  UserAccount: 'account record is owned by packages/account/user-accounts/README.md',
  UserAccountView: 'account view contract is owned by packages/account/user-accounts/README.md',
  AccountRole: 'account role vocabulary is owned by packages/account/user-accounts/README.md',
  SessionIdentity: 'session identity contract is owned by packages/account/user-accounts/README.md',
  ...
  NotificationChannel: 'channel contract is owned by packages/interaction/notification/README.md',
  EmailTransport: 'transport contract is owned by packages/email/email/README.md',
  EmailDelivery: 'delivery outcome contract is owned by packages/email/email/README.md',
  EmailMessage: 'message contract is owned by packages/email/email/README.md',
  EmailSendRequest: 'send request contract is owned by packages/email/email/README.md',
  NotificationCredentialState: 'credential-state contract is owned by packages/interaction/notification/README.md',
  NotificationCredentialStateInfo: 'credential-state wire contract is owned by packages/core/digital-employee/types.ts and the notification README',
  DigitalEmployeeTaskEntry: 'task-console row contract is owned by packages/core/digital-employee/types.ts and the management README',
  DigitalEmployeeTaskKeyRequest: 'task-console request contract is owned by packages/core/digital-employee/types.ts and the management README',
  NotificationChannelStatus: 'channel status wire contract is owned by packages/core/digital-employee/types.ts and the management README',
  NotificationChannelTestRequest: 'channel test request wire contract is owned by packages/core/digital-employee/types.ts and the management README',
  NotificationChannelTestResult: 'channel test result wire contract is owned by packages/core/digital-employee/types.ts and the management README',
  NotificationDelivery: 'delivery outcome contract is owned by packages/interaction/notification/README.md',
  NotificationMessage: 'alert message contract is owned by packages/interaction/notification/README.md',
  NotificationSendRequest: 'send request contract is owned by packages/interaction/notification/README.md',
  ...
  McpServerConfig: 'MCP transport configuration is owned by packages/mcp/mcp-client/README.md',
  ...
  SkillMarketBannerRequest: 'marketplace Remote request is owned by packages/skill/skill-market/README.md',
  SkillMarketBannerResult: 'marketplace Remote result is owned by packages/skill/skill-market/README.md',
  SkillMarketInstallRequest: 'marketplace Remote request is owned by packages/skill/skill-market/README.md',
  SkillMarketInstallResult: 'marketplace Remote result is owned by packages/skill/skill-market/README.md',
  SkillMarketListResult: 'marketplace Remote result is owned by packages/skill/skill-market/README.md',
  SkillMarketUninstallRequest: 'marketplace Remote request is owned by packages/skill/skill-market/README.md',
  SkillMarketUninstallResult: 'marketplace Remote result is owned by packages/skill/skill-market/README.md',
  ToolMarketInstallRequest: 'marketplace Remote request is owned by packages/tool/tool-market/README.md',
  ToolMarketInstallResult: 'marketplace Remote result is owned by packages/tool/tool-market/README.md',
  ToolMarketListResult: 'marketplace Remote result is owned by packages/tool/tool-market/README.md',
  ToolMarketUninstallRequest: 'marketplace Remote request is owned by packages/tool/tool-market/README.md',
  ToolMarketUninstallResult: 'marketplace Remote result is owned by packages/tool/tool-market/README.md',
  McpMarketConfigureRequest: 'marketplace Remote request is owned by packages/mcp/mcp-market/README.md',
  McpMarketConfigureResult: 'marketplace Remote result is owned by packages/mcp/mcp-market/README.md',
  HookMarketConfigureRequest: 'marketplace Remote request is owned by packages/hooks/hooks-market/README.md',
  HookMarketConfigureResult: 'marketplace Remote result is owned by packages/hooks/hooks-market/README.md',
  HookMarketInstallRequest: 'marketplace Remote request is owned by packages/hooks/hooks-market/README.md',
  HookMarketInstallResult: 'marketplace Remote result is owned by packages/hooks/hooks-market/README.md',
  HookMarketListResult: 'marketplace Remote result is owned by packages/hooks/hooks-market/README.md',
  InstalledHookPackage: 'bridge projection of an installed hook package is owned by packages/hooks/hooks-market/README.md',
  HookMarketPackageId: 'managed hook package identity is owned by packages/hooks/hooks-market/README.md',
  HookMarketUninstallRequest: 'marketplace Remote request is owned by packages/hooks/hooks-market/README.md',
  HookMarketUninstallResult: 'marketplace Remote result is owned by packages/hooks/hooks-market/README.md',
  WorkflowMarketListResult: 'marketplace Remote result is owned by packages/workflow/workflow-market/README.md',
  WorkflowMarketInstallRequest: 'marketplace Remote request is owned by packages/workflow/workflow-market/README.md',
  WorkflowMarketInstallResult: 'marketplace Remote result is owned by packages/workflow/workflow-market/README.md',
  WorkflowMarketPackageId: 'managed workflow package identity is owned by packages/workflow/workflow-market/README.md',
  WorkflowMarketUninstallRequest: 'marketplace Remote request is owned by packages/workflow/workflow-market/README.md',
  WorkflowMarketUninstallResult: 'marketplace Remote result is owned by packages/workflow/workflow-market/README.md',
  SubagentMarketListResult: 'marketplace Remote result is owned by packages/subagent/subagent-market/README.md',
  SubagentMarketInstallRequest: 'marketplace Remote request is owned by packages/subagent/subagent-market/README.md',
  SubagentMarketInstallResult: 'marketplace Remote result is owned by packages/subagent/subagent-market/README.md',
  SubagentMarketPackageId: 'managed subagent package identity is owned by packages/subagent/subagent-market/README.md',
  SubagentMarketUninstallRequest: 'marketplace Remote request is owned by packages/subagent/subagent-market/README.md',
  SubagentMarketUninstallResult: 'marketplace Remote result is owned by packages/subagent/subagent-market/README.md',
  InstalledWorkflowPackage: 'bridge projection of an installed workflow package is owned by packages/workflow/workflow-market/README.md',
  InstalledSubagentPackage: 'bridge projection of an installed subagent package is owned by packages/subagent/subagent-market/README.md',
  McpDirectConfigDeleteRequest: 'marketplace Remote request is owned by packages/mcp/mcp-market/README.md',
  McpDirectConfigDeleteResult: 'marketplace Remote result is owned by packages/mcp/mcp-market/README.md',
  McpDirectConfigSaveRequest: 'marketplace Remote request is owned by packages/mcp/mcp-market/README.md',
  McpDirectConfigSaveResult: 'marketplace Remote result is owned by packages/mcp/mcp-market/README.md',
  McpMarketInstallRequest: 'marketplace Remote request is owned by packages/mcp/mcp-market/README.md',
  McpMarketInstallResult: 'marketplace Remote result is owned by packages/mcp/mcp-market/README.md',
  McpMarketListResult: 'marketplace Remote result is owned by packages/mcp/mcp-market/README.md',
  McpMarketTemplateConfiguration: 'credential-free template declaration is owned by packages/mcp/mcp-market/README.md',
