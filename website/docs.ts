...
const homeAndGuide = pairedPages([
  ...
  {
    source: 'docs/user/guide/digital-employees.md',
    route: 'guide/digital-employees.md',
    label: { root: '管理数字员工', en: 'Manage digital employees' },
    sidebar: { root: 'zh-guide', en: 'en-guide' },
    section: { root: '入门', en: 'Guide' },
    order: 3,
  },
...
const subsystemGroups = [
  ...
  ['策略与交互', 'Policy and interaction', [
    ...
    ['notification.md', '通知', 'Notifications'],
  ]],
