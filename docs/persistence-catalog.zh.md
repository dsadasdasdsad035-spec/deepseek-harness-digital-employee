...
#### `digital-employee/expert-authorization-denied` — log-only
...
#### `digital-employee/expert-delegation` — log-only
...
#### `digital-employee/expert-result` — log-only
...
#### `digital-employee/identity` — log-only
...
来源：[`packages/core/digital-employee/src/types.ts:240`](../packages/core/digital-employee/src/types.ts)

<a id="digital-employeeinstructions--log-only"></a>

#### `digital-employee/instructions` — log-only
...
#### `digital-employee/memory-decision` — log-only
...
#### `digital-employee/memory-projection` — log-only
