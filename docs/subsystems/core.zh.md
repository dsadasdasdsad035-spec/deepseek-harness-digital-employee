...
Types: [CompanyGroupView](../user/guide/digital-employees.zh.md) · [CompanyId](../user/guide/digital-employees.zh.md) · [EmployeePresenceRequest](../user/guide/digital-employees.zh.md) · [EmployeePresenceView](../user/guide/digital-employees.zh.md) · [ReportEmployeeVisitRequest](../user/guide/digital-employees.zh.md)
