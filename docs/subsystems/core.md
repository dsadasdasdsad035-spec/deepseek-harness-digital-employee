...
Types: [AddDepartmentRequest](../user/guide/digital-employees.md) · [AssignEmployeeRequest](../user/guide/digital-employees.md) · [CompanyId](../user/guide/digital-employees.md) · [CompanyPromoImageRef](../user/guide/digital-employees.md) · [CompanyProvider](../user/guide/digital-employees.md) · [CompanyRecord](../user/guide/digital-employees.md) · [CreateCompanyRequest](../user/guide/digital-employees.md) · [DeleteDepartmentRequest](../user/guide/digital-employees.md) · [EmployeeBinding](../user/guide/digital-employees.md) · [RenameDepartmentRequest](../user/guide/digital-employees.md) · [ReorderDepartmentsRequest](../user/guide/digital-employees.md) · [UnassignEmployeeRequest](../user/guide/digital-employees.md) · [UpdateCompanyRequest](../user/guide/digital-employees.md)
...
Types: [AddDepartmentRequest](../user/guide/digital-employees.md) · [AssignEmployeeRequest](../user/guide/digital-employees.md) · [CompanyCandidateEmployee](../user/guide/digital-employees.md) · [CompanyFloor](../user/guide/digital-employees.md) · [CompanyIdRequest](../user/guide/digital-employees.md) · [CompanyPromoImageValue](../user/guide/digital-employees.md) · [CompanyRecord](../user/guide/digital-employees.md) · [CompanyWorldStateView](../user/guide/digital-employees.md) · [CreateCompanyRequest](../user/guide/digital-employees.md) · [DeleteDepartmentRequest](../user/guide/digital-employees.md) · [EmployeeBinding](../user/guide/digital-employees.md) · [RenameDepartmentRequest](../user/guide/digital-employees.md) · [ReorderDepartmentsRequest](../user/guide/digital-employees.md) · [ReportCompanyWorldStateRequest](../user/guide/digital-employees.md) · [SetCompanyPromoImageRequest](../user/guide/digital-employees.md) · [UnassignEmployeeRequest](../user/guide/digital-employees.md) · [UpdateCompanyRequest](../user/guide/digital-employees.md)
 ...
 */
async resolveExpert( request: ResolveDigitalEmployeeExpertRequest, ): Promise<ResolvedDigitalEmployeeExpert>
 ...
 */
async delegateToExpert( request: DelegateToDigitalEmployeeExpertRequest, ): Promise<DigitalEmployeeExpertDelegation>
 ...
 */
async promoteMemory( parent: Agent, candidate: DigitalEmployeeMemoryCandidate, ): Promise<DigitalEmployeeMemoryDecision>
 ...
 */
followupExpert( parent: Agent, childId: SessionId, content: SubagentStartRequest['prompt'], options: SubagentFollowupOptions, ): ReturnType<Context['subagents']['followup']>
 ...
 */
listExpertTree( rootSessionId: SessionId, signal?: AbortSignal, ): Promise<SubagentDescendantListEntry[]>
...
Source: [`packages/core/digital-employee-agent/src/index.ts`](../../packages/core/digital-employee-agent/src/index.ts)

<a id="ctxdigitalemployeemanagement--digitalemployeemanagementgateway"></a>

### `ctx.digitalEmployeeManagement` — `DigitalEmployeeManagementGateway`
 ...
 */
@Remote('list') list(): Promise<readonly DigitalEmployeeInstance[]>

/** Inspect one required employee.
 * @param request - required employee identity.
 * @returns employee snapshot.
 */
@Remote('get') get(request: DigitalEmployeeIdentityRequest): Promise<DigitalEmployeeInstance>
 ...
 */
@Remote('activate') activate(request: DigitalEmployeeIdentityRequest): Promise<DigitalEmployeeInstance>

/** Deactivate an active employee.
 * @param request - employee to deactivate.
 * @returns inactive employee.
 */
@Remote('deactivate') deactivate(request: DigitalEmployeeIdentityRequest): Promise<DigitalEmployeeInstance>

/** Delete an employee after owned work and connections terminate.
 * @param request - employee to remove.
 */
@Remote('delete') delete(request: DigitalEmployeeIdentityRequest): Promise<void>
 ...
 */
@Remote('startChat') startChat( request: DigitalEmployeeStartChatRequest, signal: AbortSignal, ): Promise<DigitalEmployeeStartChatValue>

/** Query bounded employee-owned memory.
 * @param request - bounded employee memory query.
 * @returns matching employee-owned records.
 */
@Remote('listMemory') listMemory(request: DigitalEmployeeMemoryQuery): Promise<readonly DigitalEmployeeMemoryRecord[]>

/** Delete one employee-owned memory.
 * @param request - employee-owned memory identity.
 */
@Remote('deleteMemory') deleteMemory(request: DigitalEmployeeDeleteMemoryRequest): Promise<void>
 ...
 */
@Remote('listExperts') async listExperts(request: DigitalEmployeeIdentityRequest): Promise<readonly DigitalEmployeeExpert[]>
 ...
 */
@Remote('taskTree') async taskTree(request: DigitalEmployeeTaskTreeRequest): Promise<DigitalEmployeeTaskTreeEntry[]>

/** Continue a live expert child.
 * @param request - direct parent, child, and next user content.
 * @returns accepted message identity.
 */
@Remote('continueExpert') continueExpert(request: DigitalEmployeeExpertContinueRequest): Promise<MessageId>

/** Interrupt a live expert subtree.
 * @param request - direct parent and child identities.
 */
@Remote('interruptExpert') interruptExpert(request: DigitalEmployeeExpertControlRequest): void

/** List attributable employee operations.
 * @param request - employee whose records are requested.
 * @returns audit history.
 */
@Remote('listAudit') listAudit(request: DigitalEmployeeIdentityRequest): Promise<readonly DigitalEmployeeAuditRecord[]>

/** Preview one exact template upgrade.
 * @param request - target template version.
 * @returns immutable capability review.
 */
@Remote('previewUpgrade') previewUpgrade(request: PreviewDigitalEmployeeUpgradeRequest): Promise<DigitalEmployeeUpgradePreview>

/** Apply one reviewed template upgrade.
 * @param request - reviewed target and explicit new grants.
 * @returns upgraded employee.
 */
@Remote('applyUpgrade') applyUpgrade(request: ApplyDigitalEmployeeUpgradeRequest): Promise<DigitalEmployeeInstance>

/** Export portable employee data.
 * @param request - employee and memory inclusion choice.
 * @returns credential-free artifact.
 */
@Remote('exportEmployee') exportEmployee(request: ExportDigitalEmployeeRequest): Promise<DigitalEmployeeExportArtifact>
...
Types: [MessageId](llm-streaming.md)

Source: [`packages/host/digital-employee-management/src/index.ts`](../../packages/host/digital-employee-management/src/index.ts)

<a id="ctxdigitalemployees--digitalemployees"></a>

### `ctx.digitalEmployees` — `DigitalEmployees`
...
Types: [DigitalEmployeeInstanceId](../user/guide/digital-employees.md) · [DigitalEmployeeLifecycleState](../user/guide/digital-employees.md) · [DigitalEmployeeTemplateId](../user/guide/digital-employees.md)

Source: [`packages/core/digital-employee/src/index.ts`](../../packages/core/digital-employee/src/index.ts)
...
Types: [CompanyId](../user/guide/digital-employees.md)

Source: [`packages/core/company/src/index.ts`](../../packages/core/company/src/index.ts)

<a id="digital-employees-events"></a>

### `digital-employees/*` events

<a id="digital-employeesbefore-delete--serial"></a>

#### `digital-employees/before-delete` — serial
...
Types: [DigitalEmployeeInstanceId](../user/guide/digital-employees.md)

Source: [`packages/core/digital-employee/src/index.ts`](../../packages/core/digital-employee/src/index.ts)

<a id="digital-employeesinstance-change--emit"></a>

#### `digital-employees/instance-change` — emit
...
Types: [DigitalEmployeeInstanceId](../user/guide/digital-employees.md) · [DigitalEmployeeLifecycleState](../user/guide/digital-employees.md)

Source: [`packages/core/digital-employee/src/index.ts`](../../packages/core/digital-employee/src/index.ts)

<a id="digital-employeestemplate-change--emit"></a>

#### `digital-employees/template-change` — emit
...
Types: [DigitalEmployeeTemplateId](../user/guide/digital-employees.md)
