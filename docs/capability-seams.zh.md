...
flowchart LR
  ...
  pkg_digital_employee --> svc_digitalEmployees
  ...
  svc_digitalEmployeeAgent --> pkg_digital_employee_management
  svc_digitalEmployeeManagement --> pkg_ui_digital_employees
  svc_digitalEmployees --> pkg_digital_employee_agent
  svc_digitalEmployees --> pkg_digital_employee_management
  ...
  svc_skillMarket --> pkg_ui_skill_market
