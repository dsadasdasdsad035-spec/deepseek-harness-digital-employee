...
<a id="deepseek-aidsh-digital-employee-file"></a>
...
来源： [`packages/hooks/hooks-market/src/index.ts:40`](../packages/hooks/hooks-market/src/index.ts)
...
需要： `agentDefaultModel` · `agents` · `attachments` · `digitalEmployeeAgent` · `digitalEmployees` · `workspaceRegistry`
...
来源： [`packages/mcp/mcp-client/src/index.ts:124`](../packages/mcp/mcp-client/src/index.ts)

<a id="deepseek-aidsh-mcp-market"></a>

## `@deepseek-ai/dsh-mcp-market`

需要： `credentials` · `mcpClients`
...
来源： [`packages/mcp/mcp-market/src/index.ts:38`](../packages/mcp/mcp-market/src/index.ts)
...
来源： [`packages/skill/skill-filesystem/src/index.ts:60`](../packages/skill/skill-filesystem/src/index.ts)
...
来源： [`packages/skill/skill-market/src/index.ts:145`](../packages/skill/skill-market/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-digital-employees` ([`packages/client/ui-digital-employees/src/index.ts`](../packages/client/ui-digital-employees/src/index.ts))
...
- `@deepseek-ai/dsh-client-ui-skill-market` ([`packages/client/ui-skill-market/src/index.ts`](../packages/client/ui-skill-market/src/index.ts))
